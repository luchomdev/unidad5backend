"""
URL configuration for prontapp project.
...
from . import views
from .views import ProductoListAPIView, ProductoDetailAPIView, ServicioListAPIView, ServicioDetailAPIView
...
urlpatterns = [ 
    ...
    path('categorias/', views.CategoriaListAPIView.as_view(), name='categoria-list'),
